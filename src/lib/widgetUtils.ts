...
<div class="widgetify-share-widget">
  ...
  <div class="widgetify-share-toggle" id="widgetify-share-toggle">
    <svg width="${buttonSize * 0.5}" height="${buttonSize * 0.5}" viewBox="0 0 24 24" fill="white">
      <path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7 0-.24-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3c-1.34 0-2.68.62-3.48 1.72l-2.77 1.38c-.21.1-.42.23-.63.36l-1.35-1.3c-.15-.15-.27-.27-.56-.27-.36 0-.3-.14-.42-.47l-.95-3.12-2.77-1c-.6-.2-.6-.6.13-.9l10.8-4.15c.5-.18.96.12.61 1.32z"/>
    </svg>
  </div>
</div>
