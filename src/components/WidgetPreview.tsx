    ...
    return (
      <div style={popupStyle} className="animate-fade-in">
        ...
        <div className="bg-gray-50 border-t p-2 text-center">
          <a href="https://widgetify.vercel.app" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-xs hover:text-gray-700 transition-colors">
    ...
    return (
      <div style={popupStyle} className="animate-fade-in">
        ...
        <div className="bg-muted/50 border-t border-border p-2 text-center">
          <a href="https://widgetify.vercel.app" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-xs hover:text-foreground transition-colors">
            Powered by Widgetify
          </a>
        </div>
      </div>
