    ...
    <header className={`bg-background/80 backdrop-blur-xl border-b border-border/50 py-3 md:py-4 px-2 md:px-6 sticky top-0 z-40 shadow-soft ${classes.animation}`}>
      ...
      {isMobile && (
        <AnimatePresence>
          {menuOpen && (
            <motion.div 
              className="fixed top-[73px] left-0 right-0 bg-background/95 backdrop-blur-md shadow-elegant py-4 px-6 flex flex-col gap-2 border-t border-border max-h-[calc(100vh-73px)] overflow-y-auto z-40"
