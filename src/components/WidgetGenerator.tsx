        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 max-w-7xl mx-auto">
          <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-sm order-2 lg:order-1">
            ...
            {widgetConfig.type === 'follow-us' && (
              <div className="mb-4">
                ...
                <RadioGroup 
                  ...
                  value={widgetConfig.followPlatform} 
            ...
            <Button 
              ...
              disabled={!widgetConfig.type || (selectedTier === 'premium' && !hasPremiumAccess)}
            >
              {selectedTier === 'premium' && !hasPremiumAccess 
                ? 'Upgrade to Generate Premium Widget' 
                : `Generate ${selectedTier === 'premium' ? 'Premium' : 'Free'} Widget Code`
              }
            </Button>
          </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4 border border-purple-100">
              <a href="https://www.retailx.site/" target="_blank" rel="noopener noreferrer" className="block">
                <div className="flex flex-col items-center">
                  <img 
                    src="/lovable-uploads/08c2f5ff-5a6f-4a3e-8470-7f98661e663f.png" 
                    alt="RetailX - E-commerce Solutions" 
                    className="h-12 mb-2"
                  />
                  <p className="text-sm text-purple-600 font-medium text-center">
                    Need an e-commerce website? Check out RetailX!
                  </p>
                </div>
              </a>
            </div>
