        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          {isMobile ? <>
              ...
              >
                ...
                <a href="#widget-generator" className="text-gray-600 hover:text-purple-600 py-3 flex items-center justify-between border-b border-gray-50 pb-2" onClick={handleMenuItemClick}>
                  Generate
                </a>
                <a href="#features" className="text-gray-600 hover:text-purple-600 py-3 flex items-center justify-between border-b border-gray-50 pb-2" onClick={handleMenuItemClick}>
                  Features
                </a>
                <a href="#founder" className="text-gray-600 hover:text-purple-600 py-3 flex items-center justify-between border-b border-gray-50 pb-2" onClick={handleMenuItemClick}>
                  Founder
                </a>
                <a href="/documentation" className="text-gray-600 hover:text-purple-600 py-3 flex items-center justify-between border-b border-gray-50 pb-2" onClick={handleMenuItemClick}>
                  Documentation
                </a>
                <a href="/support" className="text-gray-600 hover:text-purple-600 py-3 flex items-center justify-between border-b border-gray-50 pb-2" onClick={handleMenuItemClick}>
                  Support
                </a>
                <div className="pt-2 pb-3">
                  <a href="https://razorpay.me/@aznoxx?amount=zPcDiUDYF4mzSgsG00XV0w%3D%3D" target="_blank" rel="noopener noreferrer" className="bg-primary hover:bg-primary/90 text-white px-4 py-3 rounded-md inline-block w-full text-center" onClick={handleMenuItemClick}>
                    Donate ₹14
                  </a>
                </div>
              </div>
