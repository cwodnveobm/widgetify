          ...
          {isMobile ? (
            <>
              <button 
                ...
                onClick={toggleMenu} 
                className="md:hidden text-gray-600 focus:outline-none p-1 rounded-md hover:bg-gray-100"
              ...
              >
                ...
                <div className="pt-2">
                  <a 
                    ...
                    className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-md inline-block w-full text-center"
                    onClick={handleMenuItemClick}
                  >
                    Donate ₹14
                  </a>
